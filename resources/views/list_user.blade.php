...
@section('list') active @endsection
@section('content')
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6 breadcrumbs-left">
                            <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Users List</span></h5>
                                    ...
                                    <form>
                                        <div class="col s12 m6 l3">
                                            ...
                                            <div class="input-field">
                                                <select class="form-control d-none" id="users-list-verified">
                                        ...
                                        <div class="col s12 m6 l3">
                                            ...
                                            <div class="input-field">
                                                <select class="form-control d-none" id="users-list-role">
                                                    <option value="">Any</option>
                                        ...
                                        <div class="col s12 m6 l3">
                                            ...
                                            <div class="input-field">
                                                <select class="form-control d-none" id="users-list-status">
                                                    <option value="">Any</option>
                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="responsive-table">
                                        <table  class="table users-list-datatable users-list-datatable"><!-- users-list-datatable"  -->
                                            <thead>
                                            <tr>
                                                <th>id</th>
                                                <th>is bot</th>
...
{{--                                                <td>300</td>--}}
{{--                                                <td>Bot</td>--}}
{{--                                                <td><a href="page-users-view.html">Dean Stanley</a></td>--}}
{{--                                                <td>Dean Stanley</td>--}}
{{--                                                <td>Dean Stanley</td>--}}
{{--                                                <td>English</td>--}}
{{--                                                <td>2020-10-27 12:07:33</td>--}}

                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6 breadcrumbs-left">
                            <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Users edit</span></h5>
                                ...
                                <div class="row">
                                    <div class="col s12" id="account">
                                        ...
                                        <div class="media display-flex align-items-center mb-2">
                                            <a class="mr-2" href="#">
                                                <img src="../../../app-assets/images/avatar/avatar-11.png" alt="users avatar" class="z-depth-4 circle" height="64" width="64">
                                            </a>
                                        ...
                                        <form action="{{ route('change_user')}}" method="post">
                                                ...
                                                <div class="col s12 m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 input-field">
                                                            <input id="username" value="{{$user['username']}}" name="username" type="text">
                                                            <label for="username">Username</label>

                                                        </div>
                                                        <div class="col s12 input-field">
                                                            <input id="name" value="{{$user['first_name']}}" name="First_Name" type="text">
                                                            <label for="name">First Name</label>

                                                        </div>
                                                        <div class="col s12 input-field">
                                                            <input id="name" value="{{$user['last_name']}}" name="Last_Name" type="text" >
                                                            <label for="name">Last Name</label>

                                                        </div>
                                                        <div class="col s12 input-field">
                                                            <input id="name" value="{{$user['language_code']}}" name="language_Code" type="text">
